...
public:
    ...
    QtCopyDialog(QWidget *parent = 0, bool delOnClose = true, Qt::WindowFlags f = Qt::WindowFlags());
    QtCopyDialog(QtFileCopier *copier, QWidget *parent = 0, bool delOnClose = true, Qt::WindowFlags f = Qt::WindowFlags());
    ~QtCopyDialog();
